...
console.log("is touch device : ", isTouchDevice),
  ...
  $(document).ready(function () {
    ...
    $(".theme-switcher").on("click", function () {
      e() ? $("html").attr("theme", "light") : $("html").attr("theme", "dark"),
    ...
    c.owlCarousel({
      ...
      $(".grid-view").click(function (e) {
        e.preventDefault(),
          ...
          $(".category-list")
            .addClass("make-grid")
            .removeClass("make-list make-compact"),
          $(".adds-wrapper").hasClass("property-list");
      }),
      ...
      $(this).width() < 767 &&
        $(".event-category-list .event-item-col").each(function (e, t) {
          ...
          $(this).find(".badge.price-tag").clone().insertAfter(s),
            i.clone().insertAfter(s);
        }),
    ...
    $(window).bind("resize load", function () {
      ...
      $("input:radio").click(function () {
        0 < $("input:radio#job-seeker:checked").length
    ...
    var r = {},
      d = {};
    a
      ? ((r = { right: "-251px" }), (d = { right: "0" }))
      : ((r = { left: "-251px" }), (d = { left: "0" })),
      ...
      $(".menu-overly-mask").click(function () {
        $(".mobile-filter-sidebar").animate(r, 250, "linear", function () {}),
    ...
    isTouchDevice ||
      ...
      $(window).scroll(function (e) {
        ...
        m < t ? s.addClass("stuck") : s.removeClass("stuck"),
          t < 450 && s.removeClass("stuck"),
          (m = t);
      })),
      ...
      $(".markAsRead").click(function (e) {
        e.stopPropagation();
        var t = $(this).closest(".list-group-item").hasClass("seen")
          ? "Mark as read"
          : "Mark as unread";
    ...
    var p = function (s) {
      $(".message-list .list-group-item").each(function () {
        ...
        t
          ? (e.closest(".list-group-item").addClass("seen"),
            e.find("i").addClass("fa-envelope-open").removeClass("fa-envelope"))
          : (e.closest(".list-group-item").removeClass("seen"),
            e
              .find("i")
